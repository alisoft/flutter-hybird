...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/FinApplet/FinApplet.framework"
  install_framework "${PODS_ROOT}/FinAppletExt/FinAppletExt.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/adjust_sdk/adjust_sdk.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/mop/mop.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/quick_actions/quick_actions.framework"
